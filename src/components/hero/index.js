...
export default function Hero() {
  return (
    <div className="hero container-fluid bg-hero-pattern w-full  bg-center bg-cover font-inter p-section px-0 relative">
      <div className=" container w-full grid grid-cols-2 h-full items-center">
        <div className="max-w-md">
          <h1 className="text-white text-48 leading-none font-bold">La manera más fácil de estrenar auto</h1>
        ...
        <div>
            <img src={heroCirlces} className="absolute right-0 bottom-0 transform -translate-x-1/2 " alt="detalle" />
        </div>
      </div>
    </div>
  );
